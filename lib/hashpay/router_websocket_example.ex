defmodule Hashpay.RouterWebSocketExample do
  @moduledoc """
  Módulo para manejar la ruta de ejemplo de WebSocket.
  """
  import Plug.Conn

  def handle_websocket_example(conn) do
    html = """
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <style>
        ...
        .user-event { color: #0066cc; font-style: italic; }
        .channel-info { display: flex; justify-content: space-between; margin-bottom: 10px; }
        .channel-selector { display: flex; align-items: center; }
        .channel-selector select { margin-left: 10px; padding: 5px; }
        .user-id { font-weight: bold; }
        .online-users { margin-top: 20px; }
        .online-users h3 { margin-bottom: 5px; }
        .user-list { border: 1px solid #eee; padding: 10px; max-height: 100px; overflow-y: auto; }
      </style>
    </head>
    <body>
      <div class="container">
        ...
        <div class="channel-info">
          ...
          <div class="channel-selector">
            ...
            <input type="text" id="custom-channel" placeholder="Nombre del canal" style="display: none; margin-left: 10px; padding: 5px;" />
          </div>
        </div>
